...
public class OneWay extends Base {
	...
	public void tc_26() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet4", 1, 3), ex.getData("Sheet4", 1, 4), ex.getData("Sheet4", 1, 5),
				ex.getData("Sheet4", 1, 6), ex.getData("Sheet4", 1, 7), ex.getData("Sheet4", 1, 8),
				ex.getData("Sheet4", 1, 9), ex.getData("Sheet4", 1, 10));
		pay();
		pay1();
		boolean data = driver.findElement(By.id("ccNum-allcardsuihandler")).isDisplayed(); // checking for credit card
																							// detail in payment page
	...
	public void tc_28() throws Exception {
		...
		Assert.assertTrue(data);
		System.out.println(driver.findElement(By.xpath("//*[text()='Select Departing Airport']"))); // Checking for
																									// Select Departing
																									// Airport message
	...
	public void tc_29() throws Exception {
		...
		Assert.assertTrue(data);
		System.out.println(driver.findElement(By.xpath("//*[text()='Select Arriving Airport']"))); // Checking for
																									// Select Arriving
																									// Airport message
