...
public class MultiCity extends Base {
	Excel_Import ex = new Excel_Import("src/test/resources/data/FlightsData.xlsx");
	Properties p = new Properties();
	ExtentReports ex1 = new ExtentReports();

	public void multicity(String from1, String to1, String from2, String to2, String airline, String pre)
			throws Exception {
	...
	public void tc_36() throws Exception {
		multicity(ex.getData("Sheet5", 1, 0), ex.getData("Sheet5", 1, 1), ex.getData("Sheet5", 1, 2),
				ex.getData("Sheet5", 1, 3), ex.getData("Sheet5", 1, 4), "all");
		booking();
		details(ex.getData("Sheet5", 1, 5), ex.getData("Sheet5", 1, 6), ex.getData("Sheet5", 1, 7),
				ex.getData("Sheet5", 1, 8), ex.getData("Sheet5", 1, 9), ex.getData("Sheet5", 1, 10),
				ex.getData("Sheet5", 1, 11), ex.getData("Sheet5", 1, 12));
		/*
		 * pay(); pay1();
		 */
	...
	public void tc_38() throws Exception {
		multicity(ex.getData("Sheet5", 2, 0), ex.getData("Sheet5", 2, 1), ex.getData("Sheet5", 2, 2),
				ex.getData("Sheet5", 2, 3), ex.getData("Sheet5", 2, 4), "all");
		Thread.sleep(1000);
	...
	public void tc_39() throws Exception {
		multicity(ex.getData("Sheet5", 3, 0), ex.getData("Sheet5", 3, 1), ex.getData("Sheet5", 3, 2),
				ex.getData("Sheet5", 3, 3), ex.getData("Sheet5", 3, 4), "all");
		Thread.sleep(1000);
	...
	public void tc_40() throws Exception {
		multicity(ex.getData("Sheet5", 4, 0), ex.getData("Sheet5", 4, 1), ex.getData("Sheet5", 4, 2),
				ex.getData("Sheet5", 4, 3), ex.getData("Sheet5", 4, 4), "all");
		Thread.sleep(1000);
		boolean data = driver.findElement(By.xpath("//*[text()='Select Departing Airport']")).isDisplayed();
		Assert.assertTrue(data);
		System.out.println(driver.findElement(By.xpath("//*[text()='Select Departing Airport']")));
	...
	public void tc_41() throws Exception {
		multicity(ex.getData("Sheet5", 5, 0), ex.getData("Sheet5", 5, 1), ex.getData("Sheet5", 5, 2),
				ex.getData("Sheet5", 5, 3), ex.getData("Sheet5", 5, 4), "all");
		Thread.sleep(1000);
		boolean data = driver.findElement(By.xpath("//*[text()='Select Arriving Airport']")).isDisplayed();
		Assert.assertTrue(data);
		System.out.println(driver.findElement(By.xpath("//*[text()='Select Arriving Airport']")));
