...
public class Hotels extends Base{
	...
	//	driver.findElement(By.id("confirmProceedPayBtn")).sendKeys(Keys.ENTER);
		Thread.sleep(1000);
	}
	...
	//	boolean data=driver.findElement(By.xpath("//[text()=' Your Payments are secured by SSL certificate']")).isDisplayed();
	...
	{
		driver.get("https://in.via.com/");
		search("chennai","Mr","randy","orton","qwert1234y", "987avd3210", "randy@gmail.com");
		Thread.sleep(1000);
