...
public class TravelersDetails extends Base {
	...
	Excel_Import ex = new Excel_Import("src/test/resources/data/FlightsData.xlsx"); // importing data from Excel
	...
	public void details(String title, String fname, String lname, String date, String month, String year, String mobile,
	...
	public void tc_44() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet3", 1, 3), ex.getData("Sheet3", 1, 4), ex.getData("Sheet3", 1, 5),
				ex.getData("Sheet3", 1, 6), ex.getData("Sheet3", 1, 7), ex.getData("Sheet3", 1, 8),
				ex.getData("Sheet3", 1, 9), ex.getData("Sheet3", 1, 10));
		insurance();
		msginfo();
		pay();
		pay1();
	...
	public void tc_45() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet3", 2, 3), ex.getData("Sheet3", 2, 4), ex.getData("Sheet3", 2, 5),
				ex.getData("Sheet3", 2, 6), ex.getData("Sheet3", 2, 7), ex.getData("Sheet3", 2, 8),
				ex.getData("Sheet3", 2, 9), ex.getData("Sheet3", 2, 10));
		Thread.sleep(1000);
		insurance();
		msginfo();
		pay();
	...
	public void tc_46() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet3", 3, 3), ex.getData("Sheet3", 3, 4), ex.getData("Sheet3", 3, 5),
				ex.getData("Sheet3", 3, 6), ex.getData("Sheet3", 3, 7), ex.getData("Sheet3", 3, 8),
				ex.getData("Sheet3", 3, 9), ex.getData("Sheet3", 3, 10));
		Thread.sleep(1000);
		insurance();
		msginfo();
		pay();
	...
	public void tc_47() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet3", 4, 3), ex.getData("Sheet3", 4, 4), ex.getData("Sheet3", 4, 5),
				ex.getData("Sheet3", 4, 6), ex.getData("Sheet3", 4, 7), ex.getData("Sheet3", 4, 8),
				ex.getData("Sheet3", 4, 9), ex.getData("Sheet3", 4, 10));
		insurance();
		Thread.sleep(1000);
		msginfo();
		Thread.sleep(1000);
	...
	public void tc_48() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet3", 5, 3), ex.getData("Sheet3", 5, 4), ex.getData("Sheet3", 5, 5),
				ex.getData("Sheet3", 5, 6), ex.getData("Sheet3", 5, 7), ex.getData("Sheet3", 5, 8),
				ex.getData("Sheet3", 5, 9), ex.getData("Sheet3", 5, 10));
		insurance();
		msginfo();
		pay();
		boolean data = driver.findElement(By.xpath("//*[text()='Required']")).isDisplayed();
	...
	public void tc_49() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet3", 6, 3), ex.getData("Sheet3", 6, 4), ex.getData("Sheet3", 6, 5),
				ex.getData("Sheet3", 6, 6), ex.getData("Sheet3", 6, 7), ex.getData("Sheet3", 6, 8),
				ex.getData("Sheet3", 6, 9), ex.getData("Sheet3", 6, 10));
		insurance();
		msginfo();
		pay();
		boolean data = driver.findElement(By.xpath("//*[text()='Required']")).isDisplayed();
	...
	public void tc_50() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet3", 7, 3), ex.getData("Sheet3", 7, 4), ex.getData("Sheet3", 7, 5),
				ex.getData("Sheet3", 7, 6), ex.getData("Sheet3", 7, 7), ex.getData("Sheet3", 7, 8),
				ex.getData("Sheet3", 7, 9), ex.getData("Sheet3", 7, 10));
		insurance();
		msginfo();
		pay();
		boolean data = driver.findElement(By.xpath("//*[text()='Required']")).isDisplayed();
	...
	public void tc_51() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet3", 8, 3), ex.getData("Sheet3", 8, 4), ex.getData("Sheet3", 8, 5),
				ex.getData("Sheet3", 8, 6), ex.getData("Sheet3", 8, 7), ex.getData("Sheet3", 8, 8),
				ex.getData("Sheet3", 8, 9), ex.getData("Sheet3", 8, 10));
		insurance();
		msginfo();
		pay();
		boolean data = driver.findElement(By.xpath("//*[text()='Enter Valid Mobile & country code ( Required )']"))
				.isDisplayed();
		Assert.assertTrue(data);
		System.out.println(
				driver.findElement(By.xpath("//*[text()='Enter Valid Mobile & country code ( Required )']")).getText());
	...
	public void tc_52() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet3", 9, 3), ex.getData("Sheet3", 9, 4), ex.getData("Sheet3", 9, 5),
				ex.getData("Sheet3", 9, 6), ex.getData("Sheet3", 9, 7), ex.getData("Sheet3", 9, 8),
				ex.getData("Sheet3", 9, 9), ex.getData("Sheet3", 9, 10));
		insurance();
		msginfo();
		pay();
		boolean data = driver.findElement(By.xpath("//*[text()='Enter Valid Mobile & country code ( Required )']"))
	...
	public void tc_53() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet3", 10, 3), ex.getData("Sheet3", 10, 4), ex.getData("Sheet3", 10, 5),
				ex.getData("Sheet3", 10, 6), ex.getData("Sheet3", 10, 7), ex.getData("Sheet3", 10, 8),
				ex.getData("Sheet3", 10, 9), ex.getData("Sheet3", 10, 10));
		insurance();
		msginfo();
		pay();
		Thread.sleep(1000);
	...
	public void tc_54() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet3", 11, 3), ex.getData("Sheet3", 11, 4), ex.getData("Sheet3", 11, 5),
				ex.getData("Sheet3", 11, 6), ex.getData("Sheet3", 11, 7), ex.getData("Sheet3", 11, 8),
				ex.getData("Sheet3", 11, 9), ex.getData("Sheet3", 11, 10));
		insurance();
		msginfo();
		pay();
		boolean data = driver.findElement(By.xpath("//*[text()='Enter Valid Email ( Required )']")).isDisplayed();
	...
	public void tc_55() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet3", 12, 3), ex.getData("Sheet3", 12, 4), ex.getData("Sheet3", 12, 5),
				ex.getData("Sheet3", 12, 6), ex.getData("Sheet3", 12, 7), ex.getData("Sheet3", 12, 8),
				ex.getData("Sheet3", 12, 9), ex.getData("Sheet3", 12, 10));
		msginfo();
		pay();
		pay1();
		boolean data = driver.findElement(By.id("ccNum-allcardsuihandler")).isDisplayed();
	...
	public void tc_56() throws Exception {
		...
		Thread.sleep(1000);
		details(ex.getData("Sheet3", 13, 3), ex.getData("Sheet3", 13, 4), ex.getData("Sheet3", 13, 5),
				ex.getData("Sheet3", 13, 6), ex.getData("Sheet3", 13, 7), ex.getData("Sheet3", 13, 8),
				ex.getData("Sheet3", 13, 9), ex.getData("Sheet3", 13, 10));
		insurance();
		pay();
